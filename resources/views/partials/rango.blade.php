<div class="input-group input-group-sm w-auto flex-nowrap date-range">
    ...
    <input type="date" class="form-control form-control-sm" id="fDesde" name="desde" value="{{ $desde->toDateString() }}" aria-label="Desde">
    <input type="date" class="form-control form-control-sm" id="fHasta" name="hasta" value="{{ $hasta->toDateString() }}" aria-label="Hasta">
</div>
